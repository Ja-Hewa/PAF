...
*** Version sums the population over 40 years of age
*** exposed to each Lden level and then determines total
*** noise-related PAF.
*--------------------------------------------------
* Hegewald, Janice
*--------------------------------------------------
...
gen PAFnom`val' = p_exp * (RR`val'-1) 
gen PAFden`val' = (p_exp * (RR`val')) 
gen lPAFnom`val' = p_exp * (LC`val'-1) 
gen lPAFden`val' = (p_exp * (LC`val'))
gen uPAFnom`val' = p_exp * (UC`val'-1) 
gen uPAFden`val' = (p_exp * (UC`val')) 
